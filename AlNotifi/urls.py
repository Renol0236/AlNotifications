...
urlpatterns = [
    ...
    path('all_notifications/', NotificationsListView.as_view(), name="all_notifications"),
    ...
    path('ouath2/discord/unlink/', discord_unlink, name='discord_unlink'),
    ...
    path('api/list_notifications/', NotificationsListApiView.as_view(), name='list_notifications'),
]
