...
SECRET_KEY = 'django-insecure-g(l76jk^4he75-wp6k^qurs==64zn4_-1l18seo)!ms^=y8vej'
...
SOCIAL_AUTH_DISCORD_SECRET = '8YDjA3IL5xP5eM2gyV2sAFhggAQPflLU'
SOCIAL_AUTH_DISCORD_SCOPE = ['identify', 'email']
SOCIAL_AUTH_DISCORD_REDIRECT_URI = 'http://localhost:8000/auth/discord/callback/'
